...
const Card = ({ 
  ...
  const renderCardContent = () => {
    ...
    if (customContent) {
      return customContent(mappedItem);
    }
  ...
  const renderCardFooter = () => {
    ...
    if (customFooter) {
      return customFooter(mappedItem);
    }
      ...
      return (
        <div className='flex items-center justify-between w-full'>
          ...
          <button 
            ...
            className='bg-blue-800 text-white flex w-1/2 justify-center items-center px-3 py-2 text-xs font-medium gap-1 rounded'
          >
    ...
    return (
      <>
        ...
        <button 
          onClick={() => onActionClick?.(item)}
          className='bg-blue-800 text-white flex w-4/12 justify-center items-center px-3 py-2 ml-2 text-xs font-medium gap-1 rounded'
        >
          <span className="text-xs">»</span>
          {actionLabel}
        </button>
